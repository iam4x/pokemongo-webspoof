...
import GoToPlace from './views/go-to-place.js'
import SpeedCounter from './views/speed-counter.js'
import BooleanSettings from './views/boolean-settings.js'
import Coordinates from './views/coordinates.js'
import SpeedLimit from './views/speed-limit.js'
import Controls from './views/controls.js'
import TotalDistance from './views/total-distance.js'
